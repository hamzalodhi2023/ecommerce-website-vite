...
function Contact() {
  return (
    <>
      ...
      <h2 className="my-5 text-center text-3xl font-semibold">Contact Us</h2>

      <form
        action="https://formspree.io/f/mjkbjzpr"
        method="POST"
        className="mb-20 flex min-h-[40dvh] w-full flex-col items-center justify-center gap-4 py-5"
      >
        <input
